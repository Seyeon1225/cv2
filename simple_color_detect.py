...
cv2.createTrackbar('Low H', 'Color Detector', 0, 225, nothing)
cv2.createTrackbar('Low S', 'Color Detector', 0, 225, nothing)
cv2.createTrackbar('Low V', 'Color Detector', 0, 225, nothing)

cv2.createTrackbar('High H', 'Color Detector', 0, 225, nothing)
cv2.createTrackbar('High S', 'Color Detector', 0, 225, nothing)
cv2.createTrackbar('High V', 'Color Detector', 0, 225, nothing)
